...
```bash
git clone https://github.com/AsfandAliMemon25/Fake-New-Detection-Python.git
```
...
I evaluated based on classifier's performance using metrics such as accuracy, precision, recall, and F1 score. The results are documented in the project files.
